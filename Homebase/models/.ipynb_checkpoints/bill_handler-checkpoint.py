    ...
    def get_dates(self):
        ...
        for date, amount in dates.items():
            ...
            if formated_date.month == today.month and formated_date > today:
                current_month_bills.append({"page": self.page, "date": date, "amount": amount})
...
class BasicFitHandler(PageHandlerParent):
    ...
    def log_in(self, email, pswrd):
        ...
        pswrd_input = self.driver.find_element(by=By.XPATH, value="//input[@name='password']")

        email_input.send_keys(email)
        pswrd_input.send_keys(pswrd)

        sub_btn = self.driver.find_element(by=By.XPATH, value="//button[@type='submit']")
...
class OrangeHandler(PageHandlerParent):
    ...
    def log_in(self, username, pswrd):
        ...
        element.click()
        user_el = self.driver.find_element(by=By.XPATH, value="//input[@placeholder='Usuario']")
        pswrd_el = self.driver.find_element(by=By.XPATH, value="//input[@placeholder='Contraseña']")
